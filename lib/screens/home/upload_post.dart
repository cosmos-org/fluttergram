          ...
          children: <Widget>[
            SimpleDialogOption(
                ...
                onPressed: () async {
                  ...
                  (await imagePicker.pickImage(source: ImageSource.camera, maxWidth: 1920, maxHeight: 1200, imageQuality: 80)) as PickedFile?;
                  setState(() {
            ...
            SimpleDialogOption(
                ...
                onPressed: () async {
                  ...
                  PickedFile imageFile =
                  (await imagePicker.pickImage(source: ImageSource.gallery, maxWidth: 1920, maxHeight: 1200, imageQuality: 80)) as PickedFile;
                  setState(() {
                    file = File(imageFile.path);
                  });
                }),
